...
export default function ConfirmPage() {
  ...
  const handleTokenConfirmation = async (token: string) => {
    ...
    try {
      // For token hash from email link
      ...
      setTimeout(() => {
        router.push('/login?message=Email confirmed successfully. Please sign in.')
      }, 2000)
    } catch (err: any) {
        ...
        <Card className="w-full max-w-md shadow-lg dark:shadow-xl border-border">
          <CardHeader className="space-y-4 text-center">
            ...
            <div className="space-y-1">
              <CardTitle className="text-3xl font-bold tracking-tight">Email Confirmed!</CardTitle>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 relative">
      ...
      <Card className="w-full max-w-md shadow-lg dark:shadow-xl border-border">
        <CardHeader className="space-y-4 text-center">
          ...
          <div className="space-y-1">
            <CardTitle className="text-3xl font-bold tracking-tight">Confirm Your Email</CardTitle>
            <CardDescription className="text-base">
        ...
        <CardContent>
          ...
          <form onSubmit={handleCodeConfirmation} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label className="text-foreground">Confirmation Code</Label>
